...
public class Middleware4 {
	...
	public void init() {
        f = new JFrame("Middleware 4");
        System.out.println("Creating Middleware 4 frame!");
        ...
        while (true) {
            ...
            /*
            if (messageFromNetwork.contains("Middleware 4")) {
                int count = 0;
    ...
    public void sendMessageToNetwork() {
        String messageM4 = "Msg #" + sendMessageNumber + " from Middleware 4 <EOM>";
        try {
            ...
            System.out.println("Sending string to the Network.");
            dataOutputStreamToServer.writeUTF(messageM4);
            textAreaSendList.append(messageM4);
    ...
    private static String getMessageFromNetwork() {
        ...
        try {
            ...
            System.out.println("ServerSocket 8085 connections...");
            ...
            System.out.println("Closing socket 8085.");
            serverSocket.close();
            socket.close();
        }
        catch (Exception e) {
    ...
    public void sendAgreedTimeStampToOtherMiddleware(String agreedTimestampString) {
        int[] otherMiddlewarePorts = { 8082, 8083, 8084, 8086 };
        try {
            InetAddress inetAddress = InetAddress.getLocalHost();
