...
public class Middleware5 {
	...
	public void init() {
        ...
        while (true) {
            ...
            /*
            if (messageFromNetwork.contains("Middleware 5")) {
                int count = 0;
    ...
    public void sendMessageToNetwork() {
        String messageM5 = "Msg #" + sendMessageNumber + " from Middleware 5 <EOM>";
        try {
            ...
            System.out.println("Sending string to the Network.");
            dataOutputStreamToServer.writeUTF(messageM5);
            textAreaSendList.append(messageM5);
